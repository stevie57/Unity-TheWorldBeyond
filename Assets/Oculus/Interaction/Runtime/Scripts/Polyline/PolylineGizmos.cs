...
{
    [ExecuteAlways]
    public class PolylineGizmos : MonoBehaviour
    {
        ...
        protected static PolylineGizmos _root = null;

        protected static PolylineGizmos Root
        {
            get
            {
                if (_root == null)
                {
                    ...
                    {
                        PolylineGizmos gizmos = polylineGizmosGO.GetComponent<PolylineGizmos>();
                        if (gizmos != null)
                        {
                            _root = gizmos;
#if UNITY_EDITOR
                ...
                if (_root == null)
                {
                    ...
                    _root = go.AddComponent<PolylineGizmos>();
#if UNITY_EDITOR
        ...
        private PolylineRenderer Renderer
        {
            get
            {
                ...
                {
                    _polylineRenderer = new PolylineRenderer();
                }
